...
stack_data1 = pd.read_csv('.\\stack_data\\tags_per_day_1_90_days_20180401.csv')
stack_data2 = pd.read_csv('.\\stack_data\\tags_per_day_2_90_days_20180401.csv')
stack_data3 = pd.read_csv('.\\stack_data\\tags_per_day_3_90_days_20180401.csv')
...
for i in data.tech.unique():
    ...
    # First plot:
    data_plot = data_week.loc[data_week['tech'] == i]
...
#    ax1.set_xlabel('Date')
    ...
    ax4.plot(data_plot['date'], np.log(data_plot['so_score_days']), 'b-', alpha = alpha)
#    ax3.set_xlabel('Date')
#    ax3.set_ylabel('Score HN', color = 'g')
    ...
    ax6.plot(data_plot['date'], np.log(data_plot['so_answers_days']), 'b-', alpha = alpha)
    ax5.set_xlabel('Date')
    ...
    ax8.plot(data_plot['date'], np.log(data_plot['so_favourites_days']), 'b-', alpha = alpha)
#    ax7.set_xlabel('Date')
