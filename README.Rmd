...
a) cumulative number of questions asked for C# on <span style="color:grey">Stack Overflow</span> to the date on x axis (<span style="color:grey">blue line</span>),
b) cumulative number of points gathered by all topic with regard to C# on <span style="color:orange">Hacker News</span> to the date on x axis (<span style="color:orange">green line</span>).
