...
select cast(timestamp as date) date,
    regexp_extract_all(lower(title),
        r"([,.\s]r[,.?!\s]|python|java|scala|ruby|[,.\s]c[,.?!\s]|c\+\+|c#|spark|hadoop|sql|css|html|javascript|php|jquery|swift|vba|shell|delphi|cobol|pascal|fortran|perl|rust)") title_match,
    regexp_extract_all(lower(text),
        r"([,.\s]r[,.?!\s]|python|java|scala|ruby|[,.\s]c[,.?!\s]|c\+\+|c#|spark|hadoop|sql|css|html|javascript|php|jquery|swift|vba|shell|delphi|cobol|pascal|fortran|perl|rust)") text_match,
    score
